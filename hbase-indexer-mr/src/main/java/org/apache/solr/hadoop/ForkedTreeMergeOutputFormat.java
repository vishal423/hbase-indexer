...
//          ((TieredMergePolicy) mergePolicy).setSegmentsPerTier(10000);
        ...
        int maxSegments = context.getConfiguration().getInt(ForkedTreeMergeMapper.MAX_SEGMENTS_ON_TREE_MERGE, Integer.MAX_VALUE);
    ...
    private void writeShardNumberFile(TaskAttemptContext context) throws IOException {
      ...
      Path shardNumberFile = new Path(workDir.getParent().getParent(), ForkedTreeMergeMapper.SOLR_SHARD_NUMBER);
