...
public class ForkedSolrCloudPartitioner extends Partitioner<Text, SolrInputDocumentWritable> implements Configurable {
  ...
  public static final String SHARDS = ForkedSolrCloudPartitioner.class.getName() + ".shards";
  public static final String ZKHOST = ForkedSolrCloudPartitioner.class.getName() + ".zkHost";
  public static final String COLLECTION = ForkedSolrCloudPartitioner.class.getName() + ".collection";
  
  private static final Logger LOG = LoggerFactory.getLogger(ForkedSolrCloudPartitioner.class);
  
  public ForkedSolrCloudPartitioner() {}
  ...
  public void setConf(Configuration conf) {
    ...
    docCollection = new ForkedZooKeeperInspector().extractDocCollection(zkHost, collection);
    ...
    List<Slice> slices = new ForkedZooKeeperInspector().getSortedSlices(docCollection.getSlices());
