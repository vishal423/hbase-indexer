...
public class SepConsumerTest {
    ...
    public void testReplicateLogEntries_MultipleKeyValuesForSingleRow() throws Exception {
        ...
        SepEvent expectedEvent = new SepEvent(TABLE_NAME, rowKey, Lists.newArrayList((Cell) kvA, (Cell) kvB),
                Bytes.toBytes("A"));
    ...
    public void testReplicateLogEntries_SingleWALEditForMultipleRows() throws IOException {
        ...
        SepEvent expectedEventA = new SepEvent(TABLE_NAME, rowKeyA, Lists.newArrayList((Cell)kvA),
                Bytes.toBytes("data"));
        SepEvent expectedEventB = new SepEvent(TABLE_NAME, rowKeyB, Lists.newArrayList((Cell)kvB),
                Bytes.toBytes("data"));
