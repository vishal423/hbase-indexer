...
public class SepReplicationSource extends ReplicationSource {
    ...
    public void init(Configuration conf, FileSystem fs, ReplicationSourceManager manager, 
            ...
            String peerClusterZnode, UUID uuid, ReplicationEndpoint replicationEndpoint, MetricsSource metrics) throws IOException {
        super.init(conf, fs, manager, queues, peers, stopper, peerClusterZnode, uuid, replicationEndpoint, metrics);
